...
// Prod: same-origin; honor vite base (e.g. /wfreport/ behind a path gateway).
const base = import.meta.env.DEV ? 'http://localhost:8000' : import.meta.env.BASE_URL.replace(/\/$/, '')
